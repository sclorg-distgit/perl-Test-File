%{?scl:%scl_package perl-Test-File}
...
Name:		%{?scl_prefix}perl-Test-File
Version:	%{rpmversion}
Release:	10%{?dist}
...
BuildRequires:	%{?scl_prefix}perl(ExtUtils::Manifest) >= 1.21
# Module Runtime
...
%changelog
* Fri Jan 03 2020 Jitka Plesnikova <jplesnik@redhat.com> - 1.44.3-10
- SCL
